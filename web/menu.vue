...
#compose_btn:hover>#share_your_recipe{
    display: inline;
}
</style>
...
<template>
    <div>
        <div id="menu_btn_container" v-if="user_id">
            <button id="menu_btn" type="button" class="btn btn-dark dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
